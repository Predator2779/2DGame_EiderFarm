...
namespace Building
{
    public class BuildMenu : MonoBehaviour
    {
        ...
        [SerializeField, Range(0, 100)] private int _buyPrice;
        [Header("Стоимость улучшений")]
        [SerializeField, Range(0, 100)] private int[] _upgradePrice = new int[1];
        [Header("Сколько возвращает при сносе (0 если 0)")]
        [SerializeField, Range(0, 100)] private int _sellPrice;
